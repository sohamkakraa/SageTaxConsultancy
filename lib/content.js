...
const FALLBACK_CONTENT = {
  ...
  contact_email: 'info@sageadvisory.ae',
...
const FALLBACK_TESTIMONIALS = [
  {
    ...
    quote_en: 'Sage Advisory successfully navigated our complex VAT audit with the FTA. Their expertise and attention to detail saved us significant time and stress. Highly recommended!',
    quote_ar: 'تنقلت Sage Advisory بنجاح من خلال تدقيق ضريبة القيمة المضافة المعقد لدينا مع سلطة الضرائب الفيدرالية. أدت خبرتهم واهتمامهم بالتفاصيل إلى توفير وقت وضغط كبير. موصى به بشدة!',
    rating: 5,
  },
];
