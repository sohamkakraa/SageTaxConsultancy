    ...
    <footer className={`bg-navy-950 text-white ${isRTL ? 'rtl' : 'ltr'}`}>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-10">
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-1 space-y-4">
            ...
            <div className="flex gap-2 pt-2">
              <SocialLink href="https://www.linkedin.com/company/sage-tax-consultancy" label="LinkedIn">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" /></svg>
              </SocialLink>
              <SocialLink href="https://www.instagram.com/sagetaxconsultancy" label="Instagram">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {[...SERVICES.tax, ...SERVICES.accounting].map(({ label, slug }) => (
                <li key={slug}>
                  <Link href={`${base}/services/${slug}`} className="text-sm text-gray-400 hover:text-white transition-colors">{label}</Link>
                </li>
              ))}
            </ul>
          </div>
      ...
      <div className="border-t border-white/10">
        <div className="container-max py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-gray-500">&copy; {year} Sage Tax Consultancy. All rights reserved.</p>
